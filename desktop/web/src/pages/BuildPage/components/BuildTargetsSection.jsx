...
export default function BuildTargetsSection({ t, apps, updateApp, hasText, getPackageIcon, setAppSettingsId, setAppSettingsOpen, isBusy, onAddCustom }) {
  return (
        ...
        {apps.map((app) => {
          ...
          return (
            <div
              ...
              <button type='button' className='inline-flex items-center gap-2 px-3 py-2 transition-colors' onClick={() => updateApp(app.id, { mode: enabled ? "false" : "remote" })}>
